...
public class EntityManager<E, ID> {
    ...
    public EntityManager(EntityModel<E> entityModel, IJdbcFacade facade) {
    ...
    protected void generateBeforeInsert(IJdbcFacade facade, E entity) {
    ...
    protected void generateAfterInsert(IJdbcFacade facade, E entity) {
        for (var p : entityModel.getAutogeneratedProperties()) {
