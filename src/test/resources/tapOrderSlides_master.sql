...
CREATE TABLE SQLUser.thcaHost
(
   ID integer PRIMARY KEY NOT NULL,
   HostName varchar(25) NOT NULL,
   Description varchar(255),
   Status BIT DEFAULT 1 NOT NULL,
   blnDefault BIT DEFAULT 0 NOT NULL,
   DriverInfo varchar(214),
   HostType varchar(50),
   rTimeZone integer,
...
INSERT INTO SQLUser.thcaHost (HostName,ID,HostType,Description) VALUES ('LIS_HL7',5,'','Host to communicate in HL7 protocol');
INSERT INTO SQLUser.thcaHost (HostName,ID,HostType,Description) VALUES ('VTG',6,'VTG','Vantage');
INSERT INTO SQLUser.thcaHost (HostName,ID,HostType,Description) VALUES ('VIP',7,'VIP','Ventana Interface Point');
...
SELECT * FROM tapOrderContainers
SELECT * FROM tapOrderBlocks
SELECT * FROM tapOrderSlides

SELECT * FROM tapOrderObjects
...
;
CREATE UNIQUE INDEX UniqueIndex ON "SQLUser"."tapOrderContainers"(ContainerID)
;
CREATE INDEX OnHoldOrderI ON "SQLUser"."tapOrderContainers"
(
  OnHold,
  rOrders
)
;
CREATE INDEX OrdersIndex ON "SQLUser"."tapOrderContainers"(rOrders)
;
CREATE INDEX OnHoldIndex ON "SQLUser"."tapOrderContainers"(OnHold)
;
CREATE INDEX SequenceIndex ON "SQLUser"."tapOrderContainers"
(
  Sequence,
  rOrders
)
;
CREATE UNIQUE INDEX PrimaryKey ON "SQLUser"."tapOrderContainers"(ID1)
;
...
;
CREATE UNIQUE INDEX UniqueIndex ON "SQLUser"."tapOrderBlocks"(BlockID)
;
CREATE INDEX OnHoldSpecimenI ON "SQLUser"."tapOrderBlocks"
(
  OnHold,
  rapOrderContainers
)
;
CREATE INDEX OnHoldIndex ON "SQLUser"."tapOrderBlocks"(OnHold)
;
CREATE INDEX apOrderContainersIndex ON "SQLUser"."tapOrderBlocks"(rapOrderContainers)
;
CREATE INDEX SequenceIndex ON "SQLUser"."tapOrderBlocks"
(
  Sequence,
  rapOrderContainers
)
;
CREATE UNIQUE INDEX PrimaryKey ON "SQLUser"."tapOrderBlocks"(ID1)
;
...
REFERENCES "SQLUser"."tOrders"(ID)
;
CREATE INDEX rapOrderBlocksIndex ON "SQLUser"."tapOrderSlides"(rapOrderBlocks)
;
CREATE INDEX rapOrderContainersIndex ON "SQLUser"."tapOrderSlides"(rapOrderContainers)
;
CREATE INDEX OnHoldIndex ON "SQLUser"."tapOrderSlides"(OnHold)
;
CREATE INDEX OnHoldSpecimenI ON "SQLUser"."tapOrderSlides"
(
  OnHold,
  rapOrderContainers
)
;
CREATE INDEX OnHoldBlockI ON "SQLUser"."tapOrderSlides"
(
  OnHold,
  rapOrderBlocks
)
;
CREATE INDEX rOrdersIndex ON "SQLUser"."tapOrderSlides"(rOrders)
;
CREATE UNIQUE INDEX PrimaryKey ON "SQLUser"."tapOrderSlides"(ID1)
;
CREATE INDEX SequenceIndex ON "SQLUser"."tapOrderSlides"
(
  Sequence,
  rOrders,
  rapOrderContainers,
...
;
CREATE UNIQUE INDEX UniqueIndex ON "SQLUser"."tapOrderSlides"(SlideID)
;
CREATE INDEX OnHoldOrderI ON "SQLUser"."tapOrderSlides"
(
  OnHold,
  rOrders
)
...
REFERENCES "SQLUser"."tapOrderContainers"(ID)
;
CREATE INDEX UniqueIndex ON "SQLUser"."tapOrderObjects"(Identifier)
;
CREATE INDEX apOrderContainersIndex ON "SQLUser"."tapOrderObjects"(rapOrderContainers)
;
CREATE INDEX apOrderBlocksIndex ON "SQLUser"."tapOrderObjects"(rapOrderBlocks)
;
CREATE INDEX apOrderSlidesIndex ON "SQLUser"."tapOrderObjects"(rapOrderSlides)
;
CREATE INDEX apOrdersIndex ON "SQLUser"."tapOrderObjects"(rOrders)
;
CREATE UNIQUE INDEX PrimaryKey ON "SQLUser"."tapOrderObjects"(ID)
;
